...
export interface ApiExposureExposure extends Struct.CollectionTypeSchema {
  collectionName: 'exposures';
  info: {
    displayName: 'Exposure';
    pluralName: 'exposures';
    singularName: 'exposure';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    caseStatus: Schema.Attribute.Enumeration<
      [
        'Investigating',
        'Confirmed',
        'Warning',
    ...
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Investigating'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    evidence: Schema.Attribute.Text;
    exposureType: Schema.Attribute.Enumeration<
      [
        'Fake License',
        'Ponzi',
        'Exit Scam',
    ...
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Fake License'>;
    ...
    publishedAt: Schema.Attribute.DateTime;
    reportedDate: Schema.Attribute.Date;
    reporterCount: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<1>;
    riskFactors: Schema.Attribute.Text;
    severity: Schema.Attribute.Enumeration<
      ['Critical', 'High', 'Medium', 'Low']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Medium'>;
    slug: Schema.Attribute.UID<'platform'> & Schema.Attribute.Required;
...
export interface ApiInsightInsight extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['Technology', 'Market', 'Security', 'Economy', 'Trading']
    > &
      Schema.Attribute.Required &
...
export interface ApiNewsItemNewsItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    platformSlug: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
...
export interface ApiPlatformPlatform extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    pairs: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::exposure.exposure': ApiExposureExposure;
