  ...
  const values = [
    {
      ...
      description: 'We prioritize the safety and security of cryptocurrency traders through rigorous verification processes.'
    },
    {
      icon: 'fas fa-eye',
      title: 'Transparency',
    ...
    },
    {
      ...
      description: 'Powered by the crypto community, for the crypto community. Your security is our mission.'
    },
    {
      icon: 'fas fa-clock',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-20">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Built on principles of security, transparency, and community trust, 
              we're committed to protecting the cryptocurrency ecosystem.
            </p>
          </div>
        ...
        <div className="mb-20 bg-white rounded-2xl shadow-xl p-8 lg:p-12">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Our impact in numbers - protecting traders and investors worldwide 
              through comprehensive platform verification services.
            </p>
          </div>
        ...
        <div>
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Working alongside industry leaders to ensure comprehensive 
              coverage and the highest standards of platform verification.
            </p>
          </div>
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-8 lg:p-12 text-white">
            ...
            <p className="text-blue-100 mb-8 max-w-2xl mx-auto">
              Help us build a safer cryptocurrency ecosystem. Report suspicious platforms, 
